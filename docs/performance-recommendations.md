...
| 1.2     | Deduplicate `getUser()` calls                         | Medium | —                     |                                                                                                |
...
| 2.2     | Switch `useLayoutEffect` to `useEffect`               | Low    | —                     |                                                                                                |
...
| 3.2     | Parallel `getUser()` + `has_app_access`               | Medium | —                     |                                                                                                |
